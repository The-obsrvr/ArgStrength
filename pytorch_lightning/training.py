...
def main(hparams) -> None:
    ...
    # initialize logging
    # Tensorboard Callback (MLFlow callback implementable as well)
    ...
    # 4 Initialize cehckpoint callback
    # -------------------------------
...
if __name__ == "__main__":
    ...
    # :TODO define the required arguments
    # :TODO add in ray tune

    # :TODO testing and prediction scripts